...
<div class="container detail-container without-bg" style="margin-top: 125px;margin-bottom:100px">
    <div class="col-12 col-lg-9 col-md-12 mb-4 m-auto  text-gorany">
        <div class="card border-0 bg-body radius-10 m-3" dir="rtl" style="margin: 0 auto !important;width: 100%;">
            <div class="card-body d-flex">

                <div class="text-gorany-content" style="align-self: center;margin-right:12px;text-align: center;">
                    <p class="text-right text-color" style="font-size: 10px;">
                    <h6 style="color:#f8ad0c" >کورد و شارستانیەت</h6>

                    <img class="radius-10 mt-4 mb-4" width="200" height="260" src="assets/img/arshef.jpg" alt="">

                    <h6 class="film-short-detail text-color" style="line-height: 1.9;text-align:justify  !important;margin-top:20px">
                    ...
                    <br>
                       ...
                       <div class="footer-text d-flex" style="flex-direction:column;">
                            <p  class="text-warning" style="font-size: 13px;">نووسینی :  سیروان ئەمین </p>
                            <p class="text-warning" style="font-size: 13px;">وەرگێڕ :  سیروان ئەمین </p>
                            <p  class="text-warning" style="font-size: 13px;">پێداچوونەوەی :  سیروان ئەمین </p>
                            <p  class="text-warning" style="font-size: 13px;">سەرچاوەکان : پێشنیاری ده‌سته‌ی نووسه‌ران, تازه‌ چاپکراوه‌کان, دسته‌بندی نشده, کتێبه‌ پێشنیارکراوه‌کان, گۆڤار و ڕۆژنامه‌کان, ماڵتی میدیا, ناساندن و ڕه‌خنه‌, نووسه‌ران و وه‌رگێڕان, هه‌واڵه‌کان</p>
                            <a href=" https://t.me/kurdishbookhouse"> https://t.me/kurdishbookhouse</a>
                        </div>
...
<div class="owl-wrapper" style="margin-bottom: 100px;">

<div class="container-fluid film-slider wtar-slider arshef owl-carousel mt-3 top-card" >
