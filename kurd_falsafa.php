...
<div class="container bg-comp radius-10 col-lg-8 col-11 p-2" style="margin-top: 140px;margin-bottom:100px">
    ...
    <div class="row text-center d-flex justify-content-center">
        <h5 class="text-center text-warning" style="line-height: 1.7;">کورد و فەلسەفە</h5>
    </div>
    ...
    <div class="row text-right text-justify justify-content-center p-4">
        ...
        <div class="first_text">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <span class="text-warning text-left d-block" dir="ltr" style="font-size: 15px;">Sirwan amin
                        :</span>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <span class="text-warning text-left d-block" dir="ltr" style="font-size: 15px;">Zhyar ALi 
                        :</span>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <span class="text-warning text-left d-block" dir="ltr" style="font-size: 15px;">Hama Ali 
                        :</span>
                </div>
        ...
        <div class="row">
                <div class="col-lg-3">
                    <span class="text-warning text-left d-block" dir="ltr" style="font-size: 15px;">karmand ahmad 
                        :</span>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <span class="text-warning text-left d-block" dir="ltr" style="font-size: 15px;">soma ali 
                        :</span>
                </div>
