...
include'header.php';
 ...
 <section id="sound_books" class="d-flex justify-cntent-center align-items-center">
...
for ($i=0; $i <10 ; $i++) { ?>   
    <div class="col mb-4">
    <a href="view_sound_book.php" style="text-decoration: none;">
          <div class="card border-0">
            <div class="card-header">
              <img class="card-img" height="276"
                src="https://www.kurdipedia.org/files/photos/2012/63610.JPG?v=46512" alt="Card image">
            </div>
            <div class="card-body">
              <center class="mb-1">
                <h6 class="card-title text-center text-color " dir="ltr"
                  style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"> کتێبی ملوانکە</h6>
              </center>
            </div>
          </div>
        </a>
