...
include'header.php';
 ...
 <section id="hunar" class="d-flex justify-cntent-center align-items-center">
    <div class="container position-relative">
      <div class="row justify-content-center">
        <div class="col-xl-8 order-lg-2 order-sm-1 text-content order-md-1">
          <h2>هونەر</h2>
            <a href="#books" class="btn btn-gradient-blue radius-10 shadow mt-4" title="گرتە بکە"> پۆستەکان ببینە</a>
        </div>
      </div>
    </div>
